...
const keywordsNumber = [
  2147483647, 6904303451, 9458583811, 2047088711, 4294967296, 2952183556,
  8589869056, 6655983616,
];
...
const quizzesData: QuizzesDataType = {
  数: {
    quizzes: quizzesNumber,
    keywords: keywordsNumber,
    devilImage: numberDevil,
  },
  原子: {
    quizzes: quizzesElement,
    keywords: keywordsElement,
    devilImage: elementDevil,
  },
  四字熟語: {
    quizzes: quizzes4Jukugo,
    keywords: keywords4Jukugo,
    devilImage: jukugoDevil,
    details: details4Jukugo,
  },
};
