  ...
  return (
    <div className="result-container">
      ...
      <h1 className="result-title">
        {isCorrect
          ? (language === "en" ? "As expected of me!" : "さすが我輩だ！")
          : (language === "en" ? "I can't guess if you don't answer properly!!" : "ちゃんと答えてくれなきゃ分からないじゃないか！！")}
      </h1>
      <h2 className="result-subtitle">{language === "en" ? "Your topic: " : "あなたのお題: "}{keyword}</h2>
      <h2 className="result-subtitle">
        {language === "en" ? "Rotanika's answer: " : "Rotanikaの答え: "}{isCorrect ? finalAnswer : (language === "en" ? "Wrong...😡" : "間違えた...😡")}
      </h2>
      <Link href="/" passHref legacyBehavior>
        <a className="result-link">{language === "en" ? "Go back to home" : "ホームに戻る"}</a>
      </Link>
    </div>
  );
};
